...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tables récentes" class="drop_button btn">Récentes</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ufr-sds&table=tuteurs">`ufr-sds`.`tuteurs`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ufr-sds&table=etudiants">`ufr-sds`.`etudiants`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=teste&table=tuteurs">`teste`.`tuteurs`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=teste&table=etudiants">`teste`.`etudiants`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ufr-sds&table=useradmin">`ufr-sds`.`useradmin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pokedex&table=pokemons">`pokedex`.`pokemons`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=auf&table=gest">`auf`.`gest`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=adouaboubar&table=etudiant">`adouaboubar`.`etudiant`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=auf&table=abonnes">`auf`.`abonnes`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=espace_membre&table=membres">`espace_membre`.`membres`</a></li></ul></div><div class="drop_list"><button title="Tables préférées" class="drop_button btn">Préférées</button><ul id="pma_favorite_list"><li class="warp_link">Pas de tables préférées.</li></ul></div><div class="clearfloat"></div></div>
