...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1014040088ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tables récentes" class="drop_button btn">Récentes</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ufr-sds&table=useradmin">`ufr-sds`.`useradmin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ufr-sds&table=tuteurs">`ufr-sds`.`tuteurs`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ufr-sds&table=etudiants">`ufr-sds`.`etudiants`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=teste&table=tuteurs">`teste`.`tuteurs`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=teste&table=etudiants">`teste`.`etudiants`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pokedex&table=pokemons">`pokedex`.`pokemons`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=auf&table=gest">`auf`.`gest`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=adouaboubar&table=etudiant">`adouaboubar`.`etudiant`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=auf&table=abonnes">`auf`.`abonnes`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=espace_membre&table=membres">`espace_membre`.`membres`</a></li></ul></div><div class="drop_list"><button title="Tables préférées" class="drop_button btn">Préférées</button><ul id="pma_favorite_list"><li class="warp_link">Pas de tables préférées.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="214d5021606e5144767c62597c2e3258">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Faire Entrée pour exécuter la requête                    </span>
                            ...
                            targetdb="ufr-sds" targettable="etudiants">
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `etudiants`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="ufr-sds" targettable="etudiants">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `etudiants`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="ufr-sds" targettable="tuteurs">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `tuteurs`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="ufr-sds" targettable="useradmin">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `useradmin`</span>
                        </div>
